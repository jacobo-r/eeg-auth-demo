...
class MIXED_FBCNet(nn.Module):
    ...
    def __init__(self, nChan, nProjChan=30, nBands=9, m=32, nTimeFilter=28, doWeightNorm=True, strideFactor=5, nClass=2, *args, **kwargs): #change proj channels for intern testing
